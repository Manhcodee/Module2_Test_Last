...
public class PhoneController {
    ...
    public void addPhoneFromInput(Scanner scanner) {
        ...
        while (!valid) {
            ...
            if (input.matches("\\d+")) {
                ...
                if (id > 0) {
                    ...
                    System.out.println("ID phải là số nguyên dương. Vui lòng nhập lại.");
                }
            } else {
        ...
        if (type == 1) {
            ...
            phoneList.add(new OfficialPhone(String.valueOf(id), name, price, quantity, manufacturer, warrantyPeriod, warrantyScope));
        } else if (type == 2) {
            ...
            phoneList.add(new ImportedPhone(String.valueOf(id), name, price, quantity, manufacturer, importedCountry, status));
        } else {
